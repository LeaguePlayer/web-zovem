	...
	<?php echo $form->textAreaControlGroup($contents,'way',array('class'=>'span8')); ?>
	...
	<?php echo $form->textAreaControlGroup($contents,'terms',array('class'=>'span8')); ?>
	...
	<?php echo $form->textAreaControlGroup($contents,'comment',array('class'=>'span8')); ?>

	<?php echo $form->textAreaControlGroup($contents,'label',array('class'=>'span8')); ?>
